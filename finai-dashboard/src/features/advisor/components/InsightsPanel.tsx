        ...
        <div className="space-y-4">
            ...
            <div className="bg-purple-900/20 border border-purple-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        <h4 className="font-semibold text-zinc-100 mb-1">Diversification Score</h4>
            ...
            <div className="bg-orange-900/20 border border-orange-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                    <span className="text-2xl">🔗</span>
                    <div className="flex-1">
                        <h4 className="font-semibold text-zinc-100 mb-1">Asset Correlation</h4>
                        <p className="text-sm text-orange-200">
                            Average correlation: <strong>{corr.average_pairwise_correlation.toFixed(2)}</strong>
                        </p>
                        <p className="text-xs mt-2 text-zinc-300 italic">{corr.assessment}</p>
                        <p className="text-xs mt-2 text-zinc-300">
            ...
            <div className="bg-red-900/20 border border-red-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                    <span className="text-2xl">📉</span>
                    <div className="flex-1">
                        <h4 className="font-semibold text-zinc-100 mb-1">Maximum Drawdown</h4>
